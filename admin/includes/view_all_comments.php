                   ...
                   <?php   
                    ...
                    while($row=mysqli_fetch_assoc($select_comments)){
                       ...
                       echo "<td>{$comment_email}</td>"; 
                        ...
                        <td> <input class="btn btn-info" type="submit" name="approve" value="Approve" ></td>
                        <td> <input class="btn btn-info" type="submit" name="disapprove" value="Disapprove" ></td>
                        </form>
                        <?php
...
if(isset($_POST['approve'])){             // POST is more secure than GET
